      ...
      return [
        {
          ...
          icon: '✔',
          act: () => post({ type: 'checkout', branch: b.name }),
          disabled: b.isHead,
        },
        { sep: true, label: '' },
        { label: 'New Branch…', icon: '🜉', act: () => post({ type: 'createBranch', startPoint: b.name }) },
        { sep: true, label: '' },
        {
          label: `Merge into ${ctx.current}`,
          icon: '⇄',
          act: () => post({ type: 'merge', branch: b.name }),
          disabled: b.isHead,
        },
        { label: 'Compare with…', icon: '⇄', act: () => ctx.onCompareFrom(b.name) },
        { sep: true, label: '' },
        {
          label: 'Delete',
          icon: '🗑',
          act: () => post({ type: 'deleteBranch', branch: b.name }),
